            ...
            },
            {
                "box": {
                    ...
                    "patcher": {
                        ...
                        "classnamespace": "box",
                        "rect": [ -21292.0, -21249.0, 813.0, 562.0 ],
                        "visible": 1,
                        "boxes": [
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 100.65385246276855, 1474.9146690368652, 150.0, 34.0 ],
                    ...
                    "patcher": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 752.0, 756.5, 124.0, 27.0 ],
                                    "text": "SIGNAL OUT"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 356.0, 66.0, 195.0, 27.0 ],
                                    "text": "IN"
                                }
                            },
                            {
                        ...
                        "lines": [
                            ...
                            },
                            {
                                "patchline": {
                                    "destination": [ "obj-2", 0 ],
                                    "midpoints": [ 1038.5, 733.5, 891.5, 733.5 ],
                                    "source": [ "obj-33", 0 ]
                                }
                            },
                            {
