...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1075.0, 130.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1355.0, 351.0, 56.0, 20.0 ],
					"text" : "<--------"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1443.0, 328.5, 151.0, 131.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 991.0, 60.0, 221.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 57.5, 220.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 1071.0, 434.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1071.0, 283.0, 68.0, 22.0 ],
					"text" : "selector~ 3"
				}
...
,
					"patching_rect" : [ 1071.0, 350.0, 91.0, 22.0 ],
					"text" : "p [REDACTED]"
				}
...
,
					"patching_rect" : [ 1264.0, 350.0, 56.0, 22.0 ],
					"text" : "p Alien X"
				}
...
,
					"patching_rect" : [ 1176.0, 350.0, 74.0, 22.0 ],
					"text" : "p Heat Blast"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 580.0, 342.0, 69.0, 20.0 ],
					"text" : "<----------"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 661.0, 301.0, 150.0, 103.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 508.5, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 345.0, 357.5, 68.0, 22.0 ],
					"text" : "selector~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 345.0, 196.5, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 196.5, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 345.0, 107.5, 45.0, 22.0 ],
					"text" : "adc~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 634.0, 425.5, 56.0, 20.0 ],
					"text" : "<--------"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 723.0, 413.5, 151.0, 117.0 ],
...
,
					"patching_rect" : [ 345.0, 424.5, 91.0, 22.0 ],
					"text" : "p [REDACTED]"
				}
...
,
					"patching_rect" : [ 538.0, 424.5, 56.0, 22.0 ],
					"text" : "p Alien X"
				}
...
,
					"patching_rect" : [ 450.0, 424.5, 74.0, 22.0 ],
					"text" : "p Heat Blast"
				}
